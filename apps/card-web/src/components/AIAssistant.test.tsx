...
describe("AIAssistant lead handoff", () => {
  ...
  it("keeps automatic lead handoff paused while preserving the explicit action", async () => {
    ...
    expect(onLeadPrompt).not.toHaveBeenCalled();
    expect(screen.getByRole("dialog")).toBeInTheDocument();

    fireEvent.click(
      screen.getByRole("button", { name: "需要人工联系？留下合作需求" }),
    );
