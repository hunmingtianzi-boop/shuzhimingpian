...
const knowledgeBase: KnowledgeItem[] = [
  {
    ...
    answer:
      `**核心定位：** 拓浙 AI 集团围绕企业名片中的 **三大核心业务** 展开。

- **AI 人才与项目孵化：** 连接学习训练、跨学科组队、真实项目与作品沉淀。
- **AI 创新赛事：** 以浙客松等赛事验证创意、能力与项目潜力。
- **AI 场景服务：** 从需求诊断、原型验证到定制开发和持续迭代。`,
...
1. **AI 人才与项目孵化：** 连接学习训练、组队、真实项目与作品沉淀。
2. **AI 创新赛事：** 以浙客松等赛事承接真实场景命题与成果验证。
3. **AI 场景服务：** 推进需求诊断、方案设计、原型验证、定制开发和持续迭代。

拓途浙享平台与学习社群是承接三大业务的生态入口和组织载体。`,
    keywords: ["三大业务", "三项业务", "核心业务", "业务", "板块", "人才孵化", "创新赛事", "场景服务"],
    source: sourceModel,
  },
  {
    id: "platform",
...
export const tuotuTenant = defineTenant({
  id: "tuotu",
  version: "2026.07-v0.2.5",
  seo: {
    title: "拓浙 AI 集团 | 青年 AI 人才与产业场景共创",
    description:
      "拓浙 AI 集团数智名片，介绍 AI 人才与项目孵化、AI 创新赛事与 AI 场景服务三大业务。",
  },
  brand: {
    name: "拓浙 AI 集团",
    shortName: "拓浙 AI",
  ...
  sections: [
    {
      ...
      showInNav: true,
      eyebrow: "生态承接体系",
      heading: "三大业务，由平台、社群与项目机制协同承接",
      description:
        "拓途浙享和学习社群提供入口与组织支持，浙客松承接创新赛事，场景服务推动真实需求落地。",
      businesses: [
        {
          icon: "globe",
          eyebrow: "平台入口",
    ...
    },
    {
      ...
      audienceHeading: "从入口到落地，四类生态载体协同承接三大业务",
      audiences: [
        {
          icon: "globe",
          title: "拓途浙享",
