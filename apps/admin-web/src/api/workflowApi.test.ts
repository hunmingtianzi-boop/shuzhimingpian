...
describe("workflowApi production contracts", () => {
  ...
  it("normalizes dashboard metrics and paginated visits", async () => {
        ...
        jsonResponse({
          data: {
            ...
            page_timeline: [{
              ...
              object_type: "product",
              object_id: "product-a",
              entered_at: "2026-07-11T01:01:47Z",
              last_activity_at: "2026-07-11T01:02:00Z",
              duration_seconds: 12.5,
            ...
            actions: [{
              ...
              object_type: "contact",
              object_id: "lead_form",
              occurred_at: "2026-07-11T01:02:30Z",
            }],
            questions: [{
              ...
              answer: "产品价格需要根据方案确认。",
              answered_at: "2026-07-11T01:02:12Z",
              response_seconds: 2,
            }],
            behavior_analysis: {
    ...
    await expect(api.getVisit("visit-1")).resolves.toMatchObject({
      ...
      pageTimeline: [{ pageTitle: "产品 A", exitReason: "navigation" }],
      actions: [{ actionLabel: "打开联系表单" }],
      questions: [{
        question: "这个产品多少钱？",
        answerStatus: "completed",
        answer: "产品价格需要根据方案确认。",
      }],
      behaviorAnalysis: { engagementScore: 76, intentLevel: "high" },
    });
    expect(fetcher.mock.calls[1][0]).toBe(
